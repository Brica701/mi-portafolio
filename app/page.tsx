            ...
            <div className="lg:col-span-7">
              ...
              <span className="px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full text-blue-400 text-xs font-black tracking-widest uppercase italic">
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <a href="/cv-isaac-cruz.pdf" download className="px-10 py-5 bg-transparent border border-blue-500/30 font-black rounded-xl hover:bg-blue-600/10 transition-all uppercase text-xs flex items-center gap-2 justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <motion.div whileHover={{ y: -5 }} className={`rounded-[2rem] border overflow-hidden p-2 transition-all ${darkMode ? 'bg-slate-900 border-white/5 hover:border-blue-500/50' : 'bg-white border-slate-200 hover:border-blue-600 shadow-lg'}`}>
              ...
              <div className="p-6 space-y-4">
                <h3 className="text-2xl font-black uppercase italic tracking-tighter">Booking App</h3>
                ...
                <div className="flex gap-3 pt-2">
                  <a href="https://github.com/Brica701/booking-frontend" target="_blank" className="flex-1 py-3 bg-blue-600 text-white rounded-xl text-center font-black text-[9px] uppercase tracking-widest hover:bg-blue-700 transition-all">Frontend</a>
                  <a href="https://github.com/Brica701/booking-backend" target="_blank" className={`flex-1 py-3 rounded-xl text-center font-black text-[9px] uppercase tracking-widest border ${darkMode ? 'border-white/10 hover:bg-white/5' : 'border-slate-300 hover:bg-slate-100'}`}>Backend</a>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div whileHover={{ y: -5 }} className={`rounded-[2rem] border overflow-hidden p-2 transition-all ${darkMode ? 'bg-slate-900 border-white/5 hover:border-emerald-500/50' : 'bg-white border-slate-200 hover:border-emerald-600 shadow-lg'}`}>
              ...
              <div className="p-6 space-y-4">
                ...
                <a href="https://github.com/Brica701/control_taller" target="_blank" className={`block w-full py-3 mt-2 rounded-xl text-center font-black text-[9px] uppercase tracking-[0.2em] transition-all ${darkMode ? 'bg-emerald-600 text-white hover:bg-emerald-700' : 'bg-slate-900 text-white'}`}>
                  Ver Repositorio
                </a>
              </div>
            </motion.div>
